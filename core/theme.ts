...
export const THEME_PRESETS: ThemePreset[] = [
  { id: 'matrix', primary: 'green', neutral: 'zinc', accent: '#00ff9d', label: 'Matrix' },
  { id: 'cyber', primary: 'cyan', neutral: 'slate', accent: '#22d3ee', label: 'Cyber blue' },
  { id: 'amber', primary: 'amber', neutral: 'stone', accent: '#fbbf24', label: 'Amber terminal' },
  { id: 'stealth', primary: 'indigo', neutral: 'gray', accent: '#818cf8', label: 'Stealth gray' },
]
