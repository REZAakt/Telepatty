...
import type { RzArticle, RzCategory } from '~~/core/rooznameh/articles'
...
const chipStyle = computed(() =>
  props.category?.color ? { color: props.category.color, borderColor: `${props.category.color}55` } : undefined,
)
</script>

<template>
  <NuxtLink
    :to="`/rooznameh/${article.slug}`"
